...
# Load Excel files
capitals_df = pd.read_excel("C:\Users\laure\OneDrive\Desktop\Project-3\Original Files\capital_cities.csv")
emissions_df = pd.read_excel('greenhouse_emission.xlsx')
surface_temps_df = pd.read_excel('annual_surface_temps.xlsx')
global_data_df = pd.read_excel('global_data.xlsx')
